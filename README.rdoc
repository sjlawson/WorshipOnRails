...
Please consult <a href="https://docs.google.com/document/d/1dBXu-zalaDALwrKnNxA7jNp4hD3sJAQz8hD1McRvCok/edit?usp=sharing" target="_blank">Issue tracking document</a> before use.
...
* Deployment instructions:
  ...
  $ git merge --no-ff unshared-local-branch
  ...
  <tt>
  $ heroku run rakd db:seed:seedfile-name-without-rb-extension
  </tt>
